...
{	
	...
	case CB:
		...
		break;
	case DD:
		current_steps = &(opcodes_timing_dd[_opcode]);
		break;
	case ED:
		current_steps = &(opcodes_timing_ed[_opcode]);
		break;
	case FD:
		current_steps = &(opcodes_timing_fd[_opcode]);
		break;
	case DDCB:
		current_steps = &(opcodes_timing_ddcb[_opcode]);
		break;
	}
	current_steps_idx = 0;
}
